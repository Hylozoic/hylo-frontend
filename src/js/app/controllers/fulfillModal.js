angular.module("hyloControllers").controller('FulfillModalCtrl', ['$scope', '$rootScope', '$modalInstance', 'Post', '$log',
  function($scope, $rootScope, $modalInstance, Post, $log) {
    ...
    $rootScope.community.members({}, function(res) {
